    ...
    _createClass(BelongsTo, [{
      ...
      value: function addMethodsToModelClass(ModelClass, key) {
        ...
        Object.defineProperty(modelPrototype, key, {
          ...
          */
          set: function set(model) {
            ...
            if (model && association.inverse() && !association.inversesAlreadyAssociated(model, this) // check for an existing match, to avoid recursion
            ) {
        ...
        */
        modelPrototype['new' + (0, _emberCliMirageUtilsInflector.capitalize)(key)] = function (attrs) {
          var parent = association.schema[(0, _emberCliMirageUtilsNormalizeName.toCollectionName)(association.modelName)]['new'](attrs);
        ...
        */
        modelPrototype['create' + (0, _emberCliMirageUtilsInflector.capitalize)(key)] = function (attrs) {
          var parent = association.schema[(0, _emberCliMirageUtilsNormalizeName.toCollectionName)(association.modelName)].create(attrs);
      ...
      */
      ...
      value: function disassociateAllDependentsFromTarget(model) {
        ...
        var dependents = this.schema[(0, _emberCliMirageUtilsNormalizeName.toCollectionName)(owner)].where(_defineProperty({}, this.getForeignKey(), model.id));
